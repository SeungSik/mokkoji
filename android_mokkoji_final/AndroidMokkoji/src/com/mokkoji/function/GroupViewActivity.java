...
public class GroupViewActivity extends Activity{
	...
	Integer userPn;
	Integer gn;
	public static final int REQUEST_CODE_GO_MEMBER=  10223;
	
	
	protected static final String TAG = GroupViewActivity.class
			.getSimpleName();

	 public void onCreate(Bundle savedInstanceState) {
		 super.onCreate(savedInstanceState);
	      
		 setContentView(R.layout.group_listshow);
	
		 
		 gListview = (ListView) findViewById(R.id.mygroup);
		 Intent getintent;
		 getintent = getIntent();
		 ...
		 gListview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View view,
					...
					Intent intent = new Intent(getApplicationContext(), ShowmemberofGroupActivity.class);
	            	intent.putExtra("userPn", userPn);
	            	intent.putExtra("gn", gn);
	            	intent.putExtra("gname", gname);
	            	startActivityForResult(intent,REQUEST_CODE_GO_MEMBER);
